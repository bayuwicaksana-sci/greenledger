...
class UpdateFiscalYearRequest extends FormRequest
{
    ...
    {
        // Auto-calculate year from start_date if it's being updated
    ...
    {
        $fiscalYearId = $this->route('fiscal_year')?->id ?? $this->route('fiscal_year');
        ...
        return [
            ...
            'year' => [
                'required',
                'integer',
                Rule::unique('fiscal_years', 'year')->ignore($fiscalYearId),
            ],
        ];
    }
